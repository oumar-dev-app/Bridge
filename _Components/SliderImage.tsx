...
function SliderImage() {
    ...
    return (
        <Container>
            <div className="w-full h-130  overflow-hidden rounded-lg  relative">
                {/* SLIDER */}
                <div
                ...
                >
                    {Images.map((item, index) => (
                        <div
                            key={item.id}
                            className="w-full transition-tranform duration-700 h-200 relative  rounded-lg bg-center bg-cover shrink-0"
                        ...
                        >
                           ...
                           { currentIndex ==index &&  <div className="absolute m-5 shadow-[0_0_40px_rgba(0,0,0,0,7)] w-110 space-y-5 bottom-90 slideUp">
                                <h2 className="text-5xl text-white font-extrabold w-60  uppercase">
                                    {item.title}
                                </h2>
